...
def main():
    while True:
        ...
        if ch == "1":
            ...
            # Automatically insert DATE & TIME
            now = datetime.now()
            record["Date"] = now.strftime("%d-%m-%Y")        # Auto Date
            record["Entry_Time"] = now.strftime("%H:%M:%S")  # Auto Time
        ...
        # 6. BILLING → ADD REQUEST TO QUEUE
            ...
            while billing_queue:
                ...
                # Ask exit time or make it automatic
